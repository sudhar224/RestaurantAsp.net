<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="SaranStreetRestaurant.about" %>
				...
				<div class="row tm-header-inner">
					...
					<nav class="col-md-6 col-12 tm-nav">
						<ul class="tm-nav-ul">
							...
							<li class="tm-nav-li"><a href="about.aspx" class="tm-nav-link active">About</a></li>
			...
			<div class="row">
				<article class="col-lg-6">
					<figure class="tm-person">
						<img src="img/chef 1.jpg" alt="Image" class="img-fluid tm-person-img" style="height: 160px; width: 240px;" />
				...
				<article class="col-lg-6">
					<figure class="tm-person">
						<img src="img/chef 2.jpg" alt="Image" class="img-fluid tm-person-img" style="height: 160px; width: 240px;" />
						<figcaption class="tm-person-description">
				...
				<div class="col-12">
					<div class="tm-history-inner">
						...
						<div class="tm-history-text"> 
							...
							<p class="tm-mb-p">As word spread of Saran's homemade pasta dishes and Luigi's wood-fired pizzas, our restaurant soon became a local favorite. With each plate served, a story unfolded — of family gatherings, celebrations, and shared moments of joy around the table.</p>
							<p>Today, "Flavors of Hearth" stands as a testament to the Saran family's dedication and the enduring spirit of our culinary heritage. With a commitment to excellence and a love for sharing good food with good company, we invite you to join us on a journey of taste and tradition that spans generations. Thank you.</p>
						</div>
					</div>	
				</div>
			</div>
